...
# 1st Quadrant
fm <- filterData$Global_active_power ~ filterData$datetime
plot(fm, type = "l", xlab = "", ylab = "Global Active Power")
...
# 3rd Quadrant
fm <- filterData$Voltage ~ filterData$datetime
plot(fm, type = "l", xlab = "datetime", ylab = "Voltage")

# 4th Quadrant
fm <- filterData$Global_reactive_power ~ filterData$datetime
plot(fm, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
